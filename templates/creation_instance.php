<form id="creation_instance" method="post" enctype="multipart/form-data">
    <input type="hidden" name="instance_id" value="<?php if (isset($instance['id'])) echo $instance['id']; ?>">
        ...
        <div class="panel-body">
            <div class="col-md-2">
                ...
                <input type="number" class="form-control" id="instance_nb_nodes" name="instance_nb_nodes" 
                    ...
                    value="<?php if (isset($instance['nb_nodes'])) echo $instance['nb_nodes']; ?>">
            </div>
            <div class="col-md-2">
                ...
                <input type="number" class="form-control" id="instance_nb_edges" name="instance_nb_edges" 
                    ...
                    value="<?php if (isset($instance['nb_edges'])) echo $instance['nb_edges']; ?>">
            </div>
            <div class="col-md-2">
                ...
                <input type="number" class="form-control" id="instance_blockage_o" name="instance_blockage_o" 
                    placeholder="Enter 'O'" 
                    value="<?php if (isset($instance['blockage_o'])) echo $instance['blockage_o']; ?>">
            </div>
            <div class="col-md-2">
                ...
                <input type="number" class="form-control" id="instance_blockage_d" name="instance_blockage_d" 
                    placeholder="Enter 'D'" 
                    value="<?php if (isset($instance['blockage_d'])) echo $instance['blockage_d']; ?>">
            </div>
            <div class="col-md-4">
                <label for="instance_file">File (.dat|.txt)</label>
                <?php if (isset($instance['filename'])): ?>
                    <input type="text" class="form-control" id="instance_file" name="instance_filename" 
                        value="<?= $instance['filename'] ?>" readonly>
                <?php else: ?>
